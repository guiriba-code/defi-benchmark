#!/usr/bin/env python3
"""
Script para buscar dados do Dune Analytics e gerar JSON para o gráfico de Taxas DeFi
Mostra taxas de Aave, Ethena, Morpho e T-Bills
...
QUERY_ID = 6517647
OUTPUT_FILE = "data/defi_rates_data.json"
