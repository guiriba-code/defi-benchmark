#!/usr/bin/env python3
"""
Script para buscar dados da terceira query do Dune Analytics (Query ID: 6555058)
Mostra dados sobre mAPOLLO e mHYPER annualized returns
...
QUERY_ID = 6555058
OUTPUT_FILE = "data/defi_rates_query3_data.json"
